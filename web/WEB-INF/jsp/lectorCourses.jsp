...
<div class="tab-content">
        ...
        <c:forEach var="course" items="${requestScope.courses.get('pending')}">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="show_journal?course_id=${course.id}" type="button" class="btn btn-primary show-journal"><fmt:message key="journal"/></a>
                    <a href="journal/report?course_id=${course.id}&title=${course.title.trim()}" type="button" class="btn btn-primary journal-report"><fmt:message key="download_journal"/></a>
                </div>
            </div>
        </c:forEach>
    </div>
    ...
    <div class="tab-pane my-courses fade" role="tabpanel" aria-labelledby="finishedCourses">
